		...
		foreach($codepeople_promote_banner_plugins as $plugin_slug => $plugin_data )
		{
			...
			if($minimum_days <= abs($now-$value) && 0<$value)
			{
				...
				<style>
					...
					#codepeople-review-banner  .main-button{height: 28px important!;border-width:1px;border-style:solid;border-radius:5px;text-decoration: none;}
				...
				<div id="codepeople-review-banner">
					<div class="codepeople-review-banner-picture">
						<img alt="" src="<?php echo esc_attr(plugins_url('/images/c0662edcefb5a4e2ab12803856ba2358.png',__FILE__));?>" style="width:80px;">
					</div>
